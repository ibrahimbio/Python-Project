...
def select(id):
    ...
    if results:
        ...
        car = Car( brand, result['make'], result['model'], result['buying_cost'], result['selling_cost'], result['quantity'], result['sold'],result['id'])
    return car
...
def cars_in_inventory(brand):
    ...
    for row in results:
        ...
        car = Car(row['make'], row['model'], row['buying_cost'], row['selling_cost'], row['quantity'], row['sold'], row['id'])
        cars.append(car)
    return cars
